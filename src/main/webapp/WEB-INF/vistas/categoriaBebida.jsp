...
<c:when test="${not empty msg}">
    ...
    <div class="card-group col-3 mb-3">
        	<div class="card h-100">
          		<img class="card-img-top" src="img/${lista.imagen}" alt="Imagen de bebida" style="height:180px">
	...
	<form action="/agregar-favorito-bebida" id="form-favorito" method="POST"></form>
    </div>
