...
public class ControladorPersonalizarPizza {
	...
	@RequestMapping(value = "/personalizar-pizza",method = RequestMethod.GET)
	public ModelAndView irAPersonalizarPizza(@RequestParam(value = "msg",required = false)String msg) {
