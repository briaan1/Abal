...
public class RepositorioCombosTest extends SpringTest {
    ...
    @Transactional
    @Rollback
    public void listarLosProductosDeLaCategoriaCombo() {
        dadoQueExistenProductosDeCategoriaPizza("combos",10);
        List<Producto> listaDeProductos=cuandoListoLosProductosDeCategoriaPizza("combos");
